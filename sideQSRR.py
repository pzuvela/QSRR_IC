...
def model_parallel(arg_iter):
    ...
    # XGB
    reg, reg_traindata, reg_testdata = regress_xgbr(trset, reg_params={'n_estimators': 403, 'learning_rate': 0.22,
                                                                       'max_depth': 3})
    ...
    if plot is True:
        _, _, response, ax2 = regress_plot(reg_testdata, reg_traindata)
